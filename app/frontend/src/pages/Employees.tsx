  ...
  return (
    <Container size="xl" py="xl">
      ...
      >
        <Table.Thead>
          <Table.Tr>
            <Table.Th style={{ width: "13%" }}>Name</Table.Th>
            <Table.Th style={{ width: "20%" }}>Email</Table.Th>
            <Table.Th style={{ width: "14%" }}>Dept</Table.Th>
            <Table.Th style={{ width: "13%" }}>Salary</Table.Th>
            <Table.Th style={{ width: "10%" }}>Status</Table.Th>
            <Table.Th style={{ width: "22%" }}>Actions</Table.Th>
          </Table.Tr>
        </Table.Thead>
        <Table.Tbody>
          {rows.map((r, i) => (
              ...
              <Table.Td>
                <Group gap="xs" wrap="nowrap">
                  ...
                  <Button
                    ...
                    px="sm"
                  >
                    {r.status === "active" ? "Offboard" : "Activate"}
                  </Button>
                </Group>
              </Table.Td>
            </Table.Tr>
      ...
      <Modal
        opened={incRow !== null}
        onClose={() => setIncRow(null)}
        title={`Increment — ${incRow?.name ?? ""}`}
        size="md"
      >
        <NumberInput
          label="Percent (0–100)"
          value={percent}
          onChange={(v) =>
            setPercent(typeof v === "number" ? v : Number(v) || 0)
          }
          min={0}
          max={100}
        />
